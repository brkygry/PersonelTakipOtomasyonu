...
namespace PersonelTakipOtomasyonu
{
    partial class frmMesaiHareketRaporu
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.mesaiRaporTableAdapter = new PersonelTakipOtomasyonu.Personel_TakipDataSetTableAdapters.mesaiRaporTableAdapter();
            ...
            reportDataSource1.Name = "mesaiRaporDataSet";
            reportDataSource1.Value = this.mesaiRaporBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "PersonelTakipOtomasyonu.mesaiHareketReport.rdlc";
            ...
            this.mesaiRaporBindingSource.DataSource = this.Personel_TakipDataSet;
            // 
        ...
        private Personel_TakipDataSetTableAdapters.mesaiRaporTableAdapter mesaiRaporTableAdapter;
    }
}